...
export function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className={`relative min-h-screen text-gray-900 ${hasCustomCursor ? 'has-custom-cursor' : ''}`}>
      <SvgFilters />
      <DotGrid />
      ...
      <footer className="relative z-20 border-t border-white/30 liquid-panel py-4 mt-20">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            <span className="text-sm font-serif tracking-tight text-gray-900">Olea Computer</span>
            
            <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[10px] font-sans font-normal tracking-[0.18em] uppercase text-gray-500">
              <a href="https://syntax.oleacomputer.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors duration-500">Syntax</a>
              <a href="https://x.com/oleacomputer" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors duration-500">X</a>
              <a href="https://linkedin.com/company/oleacomputer" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors duration-500">LinkedIn</a>
              <a href="/privacy" className="hover:text-emerald-500 transition-colors duration-500">Privacy</a>
              <a href="mailto:hello@oleacomputer.com" className="hover:text-emerald-500 transition-colors duration-500">Contact</a>
            </div>
