      ...
      <div className="relative w-full">
        ...
        <section className="relative min-h-screen flex items-center pt-20">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-start overflow-hidden">
            ...
            <div className="w-[60vw] h-screen absolute -left-[5%] top-0 bg-[radial-gradient(ellipse_at_top_left,rgba(167,243,208,0.15)_0%,rgba(229,231,235,0.2)_40%,transparent_70%)] opacity-80" />
          </div>
          ...
          <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col h-full justify-center items-start text-left">
            ...
            >
              <div className="relative p-6 md:p-10 bg-linear-to-b from-white/90 to-white/60 backdrop-blur-xl rounded-3xl md:rounded-[2.5rem] border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_2px_4px_rgba(255,255,255,1)]">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif tracking-[-0.02em] mb-6 leading-[1.15] text-gray-900 relative z-10">
                  ...
                  <span className="font-sans font-normal not-italic tracking-[-0.02em] text-transparent bg-clip-text bg-linear-to-r from-emerald-400 via-emerald-600 to-emerald-900 pr-1 drop-shadow-sm">autonomous</span> <br />
                  intelligence
                </h1>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-xl mx-auto text-center mb-20 relative">
              <motion.div 
                ...
                className="relative inline-block p-6 md:p-10 bg-linear-to-b from-white/90 to-white/60 backdrop-blur-xl rounded-3xl md:rounded-[2.5rem] border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_2px_4px_rgba(255,255,255,1)]"
              >
                <motion.h2 
                  initial={{ opacity: 0, y: 30,  }}
                  whileInView={{ opacity: 1, y: 0,  }}
                ...
                >
                  The Future is <span className="font-sans font-normal not-italic text-transparent bg-clip-text bg-linear-to-r from-emerald-400 via-emerald-600 to-emerald-900 drop-shadow-sm">Agentic</span>
                </motion.h2>
            ...
            <div className="space-y-[10vh] py-[3vh]">
              {[
                ...
                return (
                  ...
                  >
                    <div className="relative p-6 md:p-8 bg-linear-to-b from-white/90 to-white/60 backdrop-blur-xl rounded-3xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_2px_4px_rgba(255,255,255,1)] transition-all duration-700 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06),inset_0_2px_4px_rgba(255,255,255,1)] hover:border-white/80 group-hover:bg-white/80">
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-20 relative">
              <motion.div 
                ...
                className="relative inline-block p-6 md:p-10 bg-linear-to-b from-white/90 to-white/60 backdrop-blur-xl rounded-3xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_2px_4px_rgba(255,255,255,1)] z-10"
              >
                <motion.h2 
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  The <span className="font-sans font-normal not-italic text-transparent bg-clip-text bg-linear-to-r from-emerald-400 via-emerald-600 to-emerald-900 drop-shadow-sm">Autonomous</span> Ecosystem
                </motion.h2>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative group/xilo">
                  <div className="flex-1 flex flex-col items-start text-left relative z-10">
                    <div className="relative p-6 md:p-10 bg-linear-to-b from-white/90 to-white/60 backdrop-blur-xl rounded-3xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_2px_4px_rgba(255,255,255,1)]">
                      ...
                      <h3 className="text-3xl md:text-4xl font-serif tracking-[-0.02em] text-gray-900 leading-tight relative z-10 mb-4 transition-all duration-700 group-hover/xilo:text-emerald-500 group-hover/xilo:drop-shadow-[0_0_15px_rgba(16,185,129,0.5)]">XILO</h3>
                  ...
                  <div className="flex-1 w-full relative">
                    <div className="aspect-square relative max-w-xl mx-auto">
                      <div className="relative h-full w-full bg-white/80 backdrop-blur-2xl border border-gray-200/80 shadow-[0_20px_60px_rgba(0,0,0,0.04),inset_0_1px_1px_rgba(255,255,255,1),-4px_-4px_12px_rgba(255,255,255,0.8)] rounded-[2.5rem] flex items-center justify-center overflow-hidden transition-all duration-700 group-hover/xilo:-translate-y-4 group-hover/xilo:border-emerald-200/40 group-hover/xilo:bg-white/90 group-hover/xilo:shadow-[0_20px_60px_rgba(16,185,129,0.08),inset_0_1px_1px_rgba(255,255,255,1),-4px_-4px_12px_rgba(255,255,255,0.8)]">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.15)_0%,transparent_70%)] -mr-20 -mt-20 opacity-0 group-hover/xilo:opacity-100 transition-all duration-700 group-hover/xilo:scale-150" />
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.1)_0%,transparent_70%)] -ml-20 -mb-20 opacity-0 group-hover/xilo:opacity-100 transition-all duration-700 group-hover/xilo:scale-150" />
                        <Database className="w-24 h-24 md:w-32 md:h-32 stroke-1 text-gray-800 drop-shadow-sm group-hover/xilo:scale-110 group-hover/xilo:text-emerald-500 group-hover/xilo:drop-shadow-[0_0_15px_rgba(16,185,129,0.4)] transition-all duration-700 relative z-10" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24 relative group/sylva">
                  <div className="flex-1 flex flex-col items-start text-left relative z-10">
                    <div className="relative p-6 md:p-10 bg-linear-to-b from-white/90 to-white/60 backdrop-blur-xl rounded-3xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_2px_4px_rgba(255,255,255,1)]">
                      ...
                      <h3 className="text-3xl md:text-4xl font-serif tracking-[-0.02em] text-gray-900 leading-tight relative z-10 mb-4 transition-all duration-700 group-hover/sylva:text-teal-500 group-hover/sylva:drop-shadow-[0_0_15px_rgba(20,184,166,0.5)]">Sylva</h3>
                      ...
                      <div className="pt-8 relative z-10">
                        <SpotlightButton 
                          ...
                          rel="noopener noreferrer"
                          color="teal"
                          className="inline-flex items-center justify-between px-8 py-4 border border-gray-200/80 bg-white/80 backdrop-blur-xl text-gray-800 text-[10px] font-sans font-bold tracking-[0.2em] uppercase transition-all duration-700 rounded-full group/btn shadow-[0_8px_32px_rgba(0,0,0,0.04),inset_0_2px_4px_rgba(255,255,255,1)] hover:bg-white hover:shadow-[0_12px_40px_rgba(20,184,166,0.15),inset_0_2px_4px_rgba(255,255,255,1)] hover:border-teal-200/60 hover:px-10 hover:-translate-y-1 z-30 relative hover:text-teal-700"
                        >
                          <span className="relative z-10 flex items-center justify-between w-full pointer-events-none">
                            Explore Sylva
                            <ArrowRight className="w-3.5 h-3.5 ml-4 group-hover/btn:translate-x-2 transition-transform will-change-transform duration-500 text-gray-500" />
                  ...
                  <div className="flex-1 w-full relative">
                    <div className="aspect-square relative max-w-xl mx-auto">
                      <div className="relative h-full w-full bg-white/80 backdrop-blur-2xl border border-gray-200/80 shadow-[0_20px_60px_rgba(0,0,0,0.04),inset_0_1px_1px_rgba(255,255,255,1),-4px_-4px_12px_rgba(255,255,255,0.8)] rounded-[2.5rem] flex items-center justify-center overflow-hidden transition-all duration-700 group-hover/sylva:-translate-y-4 group-hover/sylva:border-teal-200/40 group-hover/sylva:bg-white/90 group-hover/sylva:shadow-[0_20px_60px_rgba(20,184,166,0.08),inset_0_1px_1px_rgba(255,255,255,1),-4px_-4px_12px_rgba(255,255,255,0.8)]">
                        <Layers className="w-24 h-24 md:w-32 md:h-32 stroke-1 text-gray-800 drop-shadow-sm group-hover/sylva:scale-110 group-hover/sylva:text-teal-500 group-hover/sylva:drop-shadow-[0_0_15px_rgba(20,184,166,0.4)] transition-all duration-700 relative z-10" />
                        <div className="absolute top-10 left-10 w-64 h-64 bg-[radial-gradient(circle_at_center,rgba(20,184,166,0.15)_0%,transparent_70%)] opacity-0 group-hover/sylva:opacity-100 transition-all duration-700 group-hover/sylva:scale-150" />
                        <div className="absolute bottom-10 right-10 w-64 h-64 bg-[radial-gradient(circle_at_center,rgba(20,184,166,0.1)_0%,transparent_70%)] opacity-0 group-hover/sylva:opacity-100 transition-all duration-700 group-hover/sylva:scale-150" />
                      </div>
                    </div>
                  </div>
                </div>
